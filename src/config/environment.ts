...
export const env: EnvironmentVariables = {
  ...
  RECOMMENDER_HF_TOKEN: process.env.RECOMMENDER_HF_TOKEN || '',

  N8N_AI_CHAT_WEBHOOK_URL: process.env.N8N_AI_CHAT_WEBHOOK_URL || '',
  AI_CHAT_WEBHOOK_TIMEOUT_MS: Number(process.env.AI_CHAT_WEBHOOK_TIMEOUT_MS || '120000'),
  AI_CHAT_INTERNAL_SECRET: process.env.AI_CHAT_INTERNAL_SECRET || '',
  ...
  EMBEDDINGS_HF_TOKEN: process.env.EMBEDDINGS_HF_TOKEN || '',
